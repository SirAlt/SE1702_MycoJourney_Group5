...
public class SmoothTileMovement : MonoBehaviour, IMovement
{
    ...
    {
        if (Configurations == null) Debug.LogWarning($"Please assign a {nameof(CollisionConfigs)} asset to the Movement script's Configurations slot of [ {gameObject.name} ].", this);
    }
#endif
}
